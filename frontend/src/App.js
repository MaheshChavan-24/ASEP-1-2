                ...
                {activeTab === 'bookings' && (
                    <div className="space-y-4">
                        {clientJobs.length === 0 ? (
                            ...
                            clientJobs.map(job => (
                                <div key={job.id} className={`p-6 bg-white border-l-4 shadow-sm rounded-xl flex justify-between items-center ${
              ...
              <form onSubmit={handlePostJob} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2"><div className="relative">
                    <input 
                      type="number" 
                      placeholder="Budget (₹)" 
                      className={`w-full p-4 bg-gray-50 rounded-2xl outline-none border transition ${
                        jobData.budget === 0 ? 'opacity-50 cursor-not-allowed bg-gray-200' : 'border-transparent focus:border-indigo-500'
                      }`}
                  ...
                  </select><input placeholder="Address" className="p-3 border rounded-xl" onChange={(e)=>setJobData({...jobData, address:e.target.value})} />
               </div>
          ...
          <div>
            ...
            {view === 'login' ? (
                <form onSubmit={handleLogin} className="space-y-4">
                    <input name="username" placeholder={t.username} className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, username: e.target.value})} />
                    <input type="password" name="password" placeholder={t.password} className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, password: e.target.value})} />
                    {error && <p className="text-red-500 text-xs font-bold">{error}</p>}
                    <button type="submit" className="w-full py-4 bg-yellow-400 text-black rounded-2xl font-bold mt-4 shadow-lg hover:bg-yellow-300 transition">{t.login}</button>
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    <input name="name" placeholder="Full Name" className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, name: e.target.value})} required />
                    <input name="username" placeholder="Username" className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, username: e.target.value})} required />
                    <input name="email" type="email" placeholder="Email Address" className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, email: e.target.value})} required />
                    <input name="phone_number" placeholder="Mobile Number" className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, phone_number: e.target.value})} required />
                    <input type="password" name="password" placeholder="Password" className="w-full p-4 bg-gray-50 rounded-2xl outline-none focus:ring-2 focus:ring-yellow-400 transition" onChange={(e) => setFormData({...formData, password: e.target.value})} required />
                    {error && <p className="text-red-500 text-xs font-bold">{error}</p>}
                    <button type="submit" className="w-full py-4 bg-yellow-500 text-black rounded-2xl font-bold shadow-lg mt-4">Create Account</button>
